<?php
  ...
  $sql="select * from employeetype where EmployeeTypeID='".$_SESSION["tipe"]."'";
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>HRMS</b> System</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  <?php echo strtoupper($_SESSION["username"])." - ".$row["EmployeeType"]; ?>
                </p>
              </li>
              <!-- Menu Footer-->
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2018 <a href="#">HRM System | Pengembangan Aplikasi Web</a>.</strong> All rights
    reserved.
  </footer>
